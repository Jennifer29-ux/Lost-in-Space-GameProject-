...
player_data new_player()
{
    ...
    // Create the sprite with 4 layers - we can turn on and off based
    ...
    sprite_hide_layer(result.player_sprite, 3);
    ...
    sprite_set_y(result.player_sprite,screen_width() - sprite_width(result.player_sprite) / 2 );
